...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_GLAZE_VERSION = "glaze_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_GLAZE_VERSION, "ro.glaze.version");
        findPreference(KEY_GLAZE_VERSION).setEnabled(true);
